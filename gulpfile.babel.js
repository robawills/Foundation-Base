...
// Build the "web" folder by running all of the below tasks
...
function copy() {
  return gulp.src(PATHS.assets)
    .pipe(gulp.dest(PATHS.web + '/assets'));
}
...
function styleGuide(done) {
  sherpa('src/styleguide/index.md', {
    output: PATHS.web + '/styleguide.html',
